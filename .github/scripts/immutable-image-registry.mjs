...
const CANONICAL_SOURCE = 'https://github.com/DevPathAi/devpath-learning-svc';
const CANONICAL_REPOSITORY = 'DevPathAi/devpath-learning-svc';
const CANONICAL_IMAGE = 'ghcr.io/devpathai/devpath-learning-svc';
