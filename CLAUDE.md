# CLAUDE.md — devpath-learning-svc

> 학습 서비스 — 온보딩 진단, 학습 경로 엔진, 콘텐츠, AI 멘토 (1st Aha)
...
- 패키지: `ai.devpath.learning` / 메인: `LearningApplication`
- Claude 호출은 devpath-ai-svc를 경유한다. 프롬프트 품질은 골든 케이스 테스트로 회귀 검증한다.
